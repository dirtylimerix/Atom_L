...
- [a-dead-trousers from the XDA forum](https://forum.xda-developers.com/member.php?u=7624432) for a similar effort on the Atom XL. 
...
Add the following
	...
	<manifest>
  	  <project name="jimbrock0/Atom_L/device_tree" path="device/Unihertz/Atom_XL" remote="github" revision="master" />
	</manifest>
...
If you don't want to include GAPPS at all or want to change the apps to be installed
	...
	gedit ~/android/lineage/device/Unihertz/Atom_L/gapps_prop.mk
...
If you want to use the default LineageOS recovery or change the settings of TWRP
	...
	gedit ~/android/lineage/device/Unihertz/Atom_L/twrp_prop.mk
