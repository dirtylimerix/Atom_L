How to build LineageOS 17.1 for the Unihertz Atom L (Atom_L)
=================================================
...
First follow [the instructions to extract and mount the stock rom files](https://github.com/jamesbrock0/Atom_L/blob/master/docs/HOW-TO-EXTRACT_FILES.md) 
